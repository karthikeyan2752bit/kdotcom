...
export function AnimatedBackground() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-clip">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_15%_15%,rgba(16,185,129,0.14),transparent_42%),radial-gradient(circle_at_85%_5%,rgba(20,184,166,0.1),transparent_38%),radial-gradient(circle_at_50%_90%,rgba(15,23,42,0.12),transparent_45%)] dark:bg-[radial-gradient(circle_at_15%_15%,rgba(16,185,129,0.16),transparent_40%),radial-gradient(circle_at_85%_5%,rgba(15,118,110,0.16),transparent_38%),radial-gradient(circle_at_50%_90%,rgba(15,23,42,0.5),transparent_45%)]" />
      ...
      />
      <motion.div
        className="absolute left-1/2 top-[30vh] h-[20rem] w-[20rem] -translate-x-[8%] rounded-full bg-slate-400/15 blur-3xl will-change-transform md:h-[24rem] md:w-[24rem] dark:bg-slate-500/12"

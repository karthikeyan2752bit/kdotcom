...
export function HeroSection() {
  return (
    <section
      id="hero"
      className="relative mx-auto grid min-h-screen max-w-7xl snap-start scroll-mt-24 items-center gap-14 px-6 pb-20 pt-20 lg:grid-cols-[1.05fr_0.95fr] lg:px-10 lg:pt-28"
    >
      ...
      <div className="flex items-center justify-center">
        <div className="hero-logo hero-logo-shimmer max-w-[420px]">
          <picture>
            <source srcSet="/media/logo.png" type="image/png" />
            <img src="/media/logo.jpg" alt="Pari Labs Logo" loading="eager" className="h-auto w-full" />
          </picture>
        </div>
      </div>
    </section>
